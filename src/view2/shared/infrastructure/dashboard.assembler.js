...
/**
 * Converts raw API responses into domain entities
 */
...
export class TaskAssembler {
    ...
    static toEntities(rs) {
        return rs.map(TaskAssembler.toEntity);
    }
}

export class ScheduleAssembler {
    static toEntity(r) {
        return new ScheduleItem(r);
    }

    static toEntities(rs) {
        return rs.map(ScheduleAssembler.toEntity);
    }
}

export class DepartmentAssembler {
    static toEntity(r) {
        return new Department(r);
    }

    static toEntities(rs) {
        return rs.map(DepartmentAssembler.toEntity);
    }
}